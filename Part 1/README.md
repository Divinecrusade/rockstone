...
#### Подход №2. Добавление утверждений
...
Метод `assert` реализован так, что вызывает завершение программы при истинности выражения только тогда, когда поднят флаг DEBUG. Соответственно, в релизной версии все вызовы функции `assert` будут опущены.
...
#### Подход №3. Использование `gsl::not_null<IO*>`
...
*[см. коммит 2e8c8f1 "fix: Potential out of vector range"](https://github.com/Divinecrusade/rockstone/commit/2e8c8f1a71213d4014d85bf8237dcefc2fa3332e)*
